...
function myhead_a() {
    $('.headbox').css({ 'top': '0px', 'position': 'fixed' });
    $('.barboxbox').css({ 'top': '45px', 'position': 'fixed' });
    $('.areabox').css({ 'top': '38px' });
}

function myhead_b() {
    $('.headbox').css({ 'top': '64px', 'position': 'absolute' });
    $('.barboxbox').css({ 'top': '109px', 'position': 'absolute' });
    $('.areabox').css({ 'top': '100px' });
}
...
function tips() {
    ...
    function myhead() {
        ...
        if (head0_pos <= -64) {
            $('.barboxbox').css({ 'top': '45px', 'position': 'fixed' });
            $('.headbox').css({ 'position': 'fixed', 'top': '0px','z-index': '4' });
            $('.areabox').css({ 'top': '38px' });
            //console.log(555555);
        } else {
            $('.headbox').css({ 'top': '64px', 'position': 'absolute' });
            $('.barboxbox').css({ 'top': '109px', 'position': 'absolute' });
            $('.areabox').css({ 'top': head0_pos + 100 + 'px' });
            //console.log(6666666);
...
function bar() {
    touch.on('.bar', 'swipe', function() {
        ...
        if (bar_pos > -20) {
            ...
            $('.bar_right').animate({ 'opacity': '0.8', 'z-index': '2' }, 1);
            hide();
        } else if (l < 20) {
            $('.bar_left').animate({ 'opacity': '0.8', 'z-index': '2' }, 1);
            $('.bar_right').animate({ 'opacity': '0', 'z-index': '-1' }, 1)
            hide();
        } else {
            $('.bar_left').animate({ 'opacity': '0.8', 'z-index': '2' });
            $('.bar_right').animate({ 'opacity': '0.8', 'z-index': '2' });
            hide();
        }
    });
...
function bar_able() {
    ...
    $('.head0_placeholder').animate({ 'height': '95px' });
    _bar_able = true;
}
